...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Immediate dental care for urgent situations including severe pain, trauma, and dental emergencies with 24/7 availability.',
      icon: Heart,
      color: 'bg-rose-100 text-rose-600',
      features: ['24/7 Emergency Line', 'Same-Day Care', 'Pain Relief', 'Trauma Treatment'],
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div className="grid lg:grid-cols-2 items-center">
              ...
              <div className="relative h-[400px] lg:h-[500px]">
                <img 
                  src="/lovable-uploads/c148b70b-93ab-49a7-9cc0-6043e1171eed.png" 
